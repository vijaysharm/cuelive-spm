...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "http://127.0.0.1:8080/CUELive.3.5.9.xcframework.zip",
            checksum: "7a7dfb557774f00bb91790a711adf092771a9eff8ac925af6084189bd101fb27"
        ),
        .binaryTarget(
            name: "CUEBluetooth",
            url: "http://127.0.0.1:8080/CUEBluetooth.0.0.12.xcframework.zip",
            checksum: "f40017a7de5742bce69e18cf01f53800b6a220f3890f5ae1ccf3737ed53d3244"
        ),
        .binaryTarget(
            name: "engine",
            url: "http://127.0.0.1:8080/engine.1.46.7.xcframework.zip",
